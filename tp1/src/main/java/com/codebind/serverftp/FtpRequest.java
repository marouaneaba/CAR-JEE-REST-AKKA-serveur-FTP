...
public class FtpRequest extends Thread {
    ...
    /* pour recevoir la donées envoyer par le serveur */
...
/* list le contenu de repertoir courant distant */
    ...
    /**/
    public void processX(String name) throws IOException, NotAuthentificationException {

        if (!this.isConnected()) {
            this.envoyerMessage("550 errour non ethentification.\r\n");
            throw new NotAuthentificationException();
        } else {
            boolean result_creer = new File(toolServer.getCurrentDirectory() + File.separator + name).createNewFile();

            if (result_creer) {
                this.envoyerMessage("257 File et bien créer.\r\n");
            } else {
                this.envoyerMessage("550 Erreur Creation de File.\r\n");
            }
        }
    }
